...
void write_book()
{
          ...
          do
          {
                    ...
                    cout<<"\nPress 1 want to add more books.";
                    cout<<"\nPress 2 want to return to main menu.\n";
                    cout<<"Enter: ";
                    cin>>more_or_main;
...
//this function is used to display a book details
...
void display_a_book(char n[])
{
 ...
 //function is used to update about the book details
void modify_book()
{
          system("cls");
          char n[20];
 ...
 //function is used to delete a book when someone buys a book
void delete_book()
{
          system("cls");
          char n[20];
...
//Function for introduction or first page
void intro()
{
    system("color 08");
	system("cls");
